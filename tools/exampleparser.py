...
# copied from OpenLayers project.
# See http://github.com/openlayers for more
...
feedPath = "http://www.procrastinatio.org/examples/"
...
if __name__ == "__main__":
    ...
    exampleList = sorted(exampleList,key=lambda x:x['modified'].lower(), reverse=True)
