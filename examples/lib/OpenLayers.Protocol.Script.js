...
OpenLayers.Protocol.Script = OpenLayers.Class(OpenLayers.Protocol, {
    ...
    createRequest: function(url, params, callback) {
        var name = "OpenLayers.Protocol.Script.callback";
        ...
        OpenLayers.Protocol.Script.queue.push({
            url: url,
            script: script,
        ...
        if (!OpenLayers.Protocol.Script.current) {
            OpenLayers.Protocol.Script.nextRequest();
        };         ;
    ...
    abort: function(response) {
        if (response) {
            ...
            for (var key in OpenLayers.Protocol.Script.queue) {
                this.destroyRequest(OpenLayers.Protocol.Script.queue[key].script);
            }
        }
    },
...
(function() {
    ...
    o.callback = function(json) {
        document.getElementsByTagName('head')[0].removeChild(o.current.script);
        o.current.callback.apply(o.scope, [json]);
        o.nextRequest();
    };

    o.nextRequest = function() {
        o.current = null;
        if (o.queue.length) {
            o.current = o.queue.shift();
            var head = document.getElementsByTagName("head")[0];
            head.appendChild(o.current.script);
        }
    };
