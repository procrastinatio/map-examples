...
function init() {
    ...
    for (var i = 0; i < controls.length; ++i) {
     ...
     _map.zoomToExtent([568546.15384615, 197880.76923077, 706046.15384615, 285380.76923077]);
}
        ...
        'default': new OpenLayers.Style({
            ...
            context: {
                getFillColor: function (feature) {
                    ...
                    return feature.attributes.name == 'Border 30 km exclusion zone' ? '#b43278' : '#d20014';
                },
